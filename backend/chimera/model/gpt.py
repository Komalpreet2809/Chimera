...
class GPT(nn.Module):
    ...
    def forward(
        ...
        cache=None,
        pos_offset: int | torch.Tensor | None = None,
        ...
        Phase 4 (batched decode): pos_offset may be per-row (batch,), and
        key_padding_mask marks which stacked-cache slots are real vs padding.
        """
